...
async def download_media_with_ytdlp(url: str, fmt: str, progress_msg: types.Message):
    ...
    def sync_download():
        ...
        opts = {
            "outtmpl": outtmpl, "progress_hooks": [progress_hook], "noplaylist": False,
            "retries": 10, "fragment_retries": 10, "sleep_interval": 5, "sleep_requests": 5,
            "throttledratelimit": 1000000, "concurrent_fragment_downloads": 4,
