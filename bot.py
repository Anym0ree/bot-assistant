...
from plugins.planner import check_reminders, morning_greeting, daily_question
...
async def on_startup_polling(dp):
    ...
    scheduler.add_job(morning_greeting, CronTrigger(minute=0))  # каждую минуту проверяет, час=8
    scheduler.add_job(daily_question, CronTrigger(minute=0))  
